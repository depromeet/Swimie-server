...
public class AuthController {
  ...
  public ResponseEntity<?> login(@RequestBody LoginDto loginDto) {
    ...
    httpHeaders.add(SecurityConstant.REFRESH_HEADER.getValue(), jwtTokenResponseDto.refreshToken());
    httpHeaders.add(SecurityConstant.ACCESS_HEADER.getValue(), jwtTokenResponseDto.accessToken());
