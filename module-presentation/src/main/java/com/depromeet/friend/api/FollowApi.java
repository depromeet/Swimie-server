...
public interface FollowApi {
    ...
    ApiResponse<FollowSliceResponse<FollowerResponse>> findFollowerList(@LoginMember Long memberId);
    ...
    @Operation
    ResponseEntity<?> cancelFollowing(
            @LoginMember Long memberId, @PathVariable("followingId") Long followingId);
}
