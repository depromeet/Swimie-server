...
public record MemberProfileResponse(
        ...
        String introduction,
        @Schema(description = "프로필 이미지 URL", example = "https://cloud.front.domain/image-name.png",requiredMode = Schema.RequiredMode.NOT_REQUIRED)
        ...
        @Schema(description = "로그인한 멤버의 정보인지", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
        Boolean isMyProfile) {
