...
public class GlobalExceptionAdvice {
	...
	public ResponseEntity<ApiResponse<?>> handleMethodArgumentNotValidException(
		...
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.REQUEST_VALIDATION, 400, validateDetails),
			HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(UnexpectedTypeException.class)
	public ResponseEntity<ApiResponse<?>> handleUnexpectedTypeException(final UnexpectedTypeException ex) {
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INVALID_TYPE, 400), HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ApiResponse<?>> handlerMissingRequestHeaderException(
		...
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INVALID_MISSING_HEADER, 400),
			HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ApiResponse<?>> handlerHttpMessageNotReadableException(
		...
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INVALID_HTTP_REQUEST, 400),
			HttpStatus.BAD_REQUEST);
	}
	...
	protected ResponseEntity<ApiResponse<?>> handlerConstraintDefinitionException(
		...
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INVALID_HTTP_REQUEST, 400, ex.toString()),
			HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ApiResponse<?>> handlerHttpRequestMethodNotSupportedException(
		...
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.METHOD_NOT_ALLOWED, 405),
	...
	public ResponseEntity<ApiResponse<?>> handleException(final Exception ex,
		...
		IOException {
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INTERNAL_SERVER, 500),
			HttpStatus.INTERNAL_SERVER_ERROR);
	}

	@ExceptionHandler(IllegalArgumentException.class)
	public ResponseEntity<ApiResponse<?>> handlerIllegalArgumentException(final IllegalArgumentException ex,
	...
	public ResponseEntity<ApiResponse<?>> handlerIoException(final IOException ex,
		final HttpServletRequest request) {
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INTERNAL_SERVER, 500),
			HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	public ResponseEntity<ApiResponse<?>> handlerRuntimeException(final RuntimeException ex,
		final HttpServletRequest request) {
		return new ResponseEntity<>(ApiResponse.fail(CommonErrorType.INTERNAL_SERVER, 500),
			HttpStatus.INTERNAL_SERVER_ERROR);
	}
